...
const TEMPLATES_DATABASE = [
...

  {
    ...
    learningObjective:
      "Students will use the Bucket Tool to fill color into target boxes marked with Apple and Heart icons without selecting any empty boxes or triggering canvas selection outlines.",
    bloomsTaxonomyLevel: "Apply",
    title: "👾 Pixel Art: Color All Boxes Marked 🍎 and 💖!",
    category: "pixel_art",
    deviceType: "mobile",
    themeColor: "#f43f5e",
    icon: "👾",
